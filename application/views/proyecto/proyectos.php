					...
					<div align="left">
						...
						?>
						<?=form_open('proyecto/proyectos/registrar',$atributo) ?>
							<fieldset>
							...
							<div class="row ajuste" align="center" style="background-color:#fff;">
								...
								<div class="col-md-6" style="background-color:;padding:0px;">
									...
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									    <div class="input-group">
									        <input id="razon" readonly maxlength="30" value="<?= set_value('razon')?>" name="razon" class="form-control" type="text">
								...
								<div class="col-md-6" style="background-color:;padding:0px;">
									...
									<div class="form-group" style="padding:5px;">
									  <label class="col-md-5 control-label" for="prependedtext">RIF</label>
									  <div class="col-md-6">
									    <input id="rif" readonly maxlength="9" name="rif" class="form-control" value="<?= set_value('rif')?>" type="text">
									  </div>
									</div>
								...
								<div class="col-md-6" align="left" style="background-color:;padding:0px;">
									...
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									        ...
									        <input id="nom_proyect" readonly maxlength="30" value="<?= set_value('nom_proyect')?>" name="nom_proyect" class="form-control" type="text">
									...
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									        <input id="costo" readonly maxlength="20" onchange="format()" value="<?= set_value('costo')?>" name="costo" class="form-control" type="text">
										...
										<div class="row ajuste">
										  ...
										  <div class="col-md-6" >
										  	<div class="col-md-5 tiempoa" style="padding:0px;padding-right:10px;">
										        <input id="tiempoa" readonly maxlength="2" value="<?= set_value('tiempoa')?>" name="tiempoa" class="form-control" min="1" step="1" type="number">
										    </div>  
										    <div class="col-md-7 tiempob" style="padding:0px;padding-left:5px;">
										    	<select id="tiempob" style="font-size:12px;" disabled name="tiempob" class="form-control">
											      <option selected value="D" <?php echo set_select('tiempob', 'TRUE', TRUE); ?>>Dia</option>
											      <option value="S" <?php echo set_select('tiempob', 'FALSE'); ?>>Semana</option>
											      <option value="M" <?php echo set_select('tiempob', 'FALSE'); ?>>Mes</option>
											    </select>
										    </div>
							...
							<div class="row ajuste" align="center" style="background-color:#f4f4f4;">
								...
								<div class="form-group" align="left" style="padding:5px;">
								  ...
								  <div class="col-md-5">                     
								    <textarea class="form-control" style="resize: none" readonly id="problema" value="" placeholder=" " name="problema"><?= set_value('problema')?></textarea>
								...
								<div class="form-group" align="left" style="padding:5px;">
								  ...
								  <div class="col-md-5">                     
								    <textarea class="form-control" style="resize: none" readonly id="diagnostico" value="" placeholder=" " name="diagnostico"><?= set_value('diagnostico')?></textarea>
								...
								<div class="form-group" align="left" style="padding:5px;">
								  ...
								  <div class="col-md-5">                     
								    <textarea class="form-control" style="resize: none" readonly id="descripcion" value="" placeholder="" name="descripcion"><?= set_value('descripcion')?></textarea>
								...
								<div class="form-group" align="left" style="padding:5px;">
								  ...
								  <div class="col-md-5">                     
								    <textarea class="form-control" style="resize: none" readonly id="beneficios" value="" placeholder="" name="beneficio"><?= set_value('beneficio')?></textarea>
									...
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-5">
									    <select id="status" readonly name="status" class="form-control">
									      <option selected value="EN EJECUCION" <?php echo set_select('status', 'EN EJECUCION', TRUE); ?>>EN EJECUCION</option>
									      <option value="POR EJECUTAR" <?php echo set_select('status', 'POR EJECUTAR'); ?>>POR EJECUTAR</option>
									      <option value="EJECUTADO" <?php echo set_select('status', 'EJECUTADO'); ?>>EJECUTADO</option>
									      <option value="SUSPENDIDO" <?php echo set_select('status', 'PARALIZADO'); ?>>PARALIZADO</option>
								...
								<!-- Prepended text-->
									<div class="form-group" style="padding:5px;" align="center">
									  ...
									  <div class="col-md-5" align="left">
									        <input id="exp_pro" readonly maxlength="100" value="<?= set_value('exp_pro')?>" name="exp_pro" class="form-control" type="text">
...
<script>
  ...
  var con=0;
	...
	$(document).ready(function(){
		...
		if (nombremta!="") {
			if (ssistema!='') {
				$("#subsistemasearch").attr("onclick","buscar_varios('sistema')");
