							...
							<div class="row ajuste" align="center" style="background-color:#f4f4f4;margin-top:15px;">
								...
								<div class="col-md-6" align="left" style="background-color:;padding:0px;">
									...
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									        <input id="vista" readonly maxlength="9" onkeyup="control()" value="<?=$mesatecnicas->tiporifmta?>-<?=$mesatecnicas->rifmta?>" name="vista" class="form-control" type="text">
								...
								<div class="col-md-6" align="left" style="background-color:;padding:0px;">
								<?php
									if ($mesatecnicas->fechaconform!='') {
										$fechaconform=formatoFecha($mesatecnicas->fechaconform);
									}else{
										$fechaconform='';
									}
									if ($mesatecnicas->fecharestruct!='') {
										$fecharestruct=formatoFecha($mesatecnicas->fecharestruct);
									}else{
										$fecharestruct='';
									}
								...
								?>
									...
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
	  										...
	  										<input id="fechaconform" readonly type="text"  value="<?=$fechaconform?>" placeholder="01-01-2016" name="fechaconform" class="form-control">
									...
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6" id="sandbox-container">
										  <div class="input-group date">
	  										<input id="fecharestruct" readonly type="text"  value="<?=$fecharestruct?>" placeholder="01-01-2016" name="fecharestruct" class="form-control"><span class="input-group-addon" style="cursor:pointer;background-color:white;"><i class="fa fa-calendar"></i></span>
										  </div>
									  </div>
									</div>
								...
								<div class="col-md-6" align="left" style="background-color:;padding:0px;">
									...
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									    	...
									    	<input type="hidden" id="estado_id" name="estado_id" value="<?=$mesatecnicas->estado_id?>">

									    <span class="help-block" style="color:rgba(0,0,0,0.3);margin:0px;margin-left:2px;padding:0px;padding-top:3px;font-size:11px;"><span style="color:rgba(0,0,0,0.5);">Nota:</span> Debe elegir un <b>Estado</b>.</span>
									  </div>
									</div>
									<!-- Prepended text-->
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									    	...
									    	<input type="hidden" id="municipio_id" name="municipio_id" value="<?=$mesatecnicas->municipio_id?>">
									    
									    <span class="help-block" style="color:rgba(0,0,0,0.3);margin:0px;margin-left:2px;padding:0px;padding-top:3px;font-size:11px;"><span style="color:rgba(0,0,0,0.5);">Nota:</span> Debe elegir un <b>Municipio</b>.</span>
									  </div>
									</div>
								...
								<div class="col-md-6" align="left" style="background-color:;padding:0px;">
									...
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									    	...
									    	<input type="hidden" id="parroquia_id" name="parroquia_id" value="<?=$mesatecnicas->parroquia_id?>">
									    
									    <span class="help-block" style="color:rgba(0,0,0,0.3);margin:0px;margin-left:2px;padding:0px;padding-top:3px;font-size:11px;"><span style="color:rgba(0,0,0,0.5);">Nota:</span> Debe elegir un <b>Parroquia</b>.</span>
									  </div>
									</div>
									<!-- Prepended text-->
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									    	...
									    	<input type="hidden" id="sector_id" name="sector_id" value="<?=$mesatecnicas->sector_id?>">
									    
									    <span class="help-block" style="color:rgba(0,0,0,0.3);margin:0px;margin-left:2px;padding:0px;padding-top:3px;font-size:11px;"><span style="color:rgba(0,0,0,0.5);">Nota:</span> Debe elegir un <b>Sector</b>.</span>
									  </div>
									</div>
								</div>
							</div>
							...
							<div class="row ajuste" style="background-color:#fff;">
								...
								<!-- Prepended text-->
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-5">
									        <input id="exp_mta" readonly maxlength="100" value="<?=$mesatecnicas->exp_mta?>" name="exp_mta" class="form-control" type="text">
								...
								<!-- Textarea -->
									<div class="form-group" align="left" style="padding:5px;">
									  ...
									  <div class="col-md-5">                     
									    <textarea class="form-control" readonly id="observaciones" value="" placeholder="Ej. Calle Polita de Lima casa 5-A" name="observaciones"><?=$mesatecnicas->observaciones?></textarea>
...
<div class="ventana" id="ventana5" style="position:fixed;">
	<div class="contventana" id="contven5" style="margin-top:130px;">
		<div class="bannvent" align="center" style="border-radius:10px 10px 0px 0px;overflow:hidden;background-color:#f5f5f5;position:relative;z-index:10;">
			<h4 style="float:left;margin-left:10px;font-weight:600;color:#E73C4B;">Informacion </h4><i class="fa fa-remove fa-lg" style="cursor:pointer;margin-top:10px;margin-right:10px;color:rgba(0,0,0,0.4);float:right;" id="cerr5"></i>
		</div>
		<div class="row ajuste" style="padding-top:10px!important;background-color:white;border-bottom:1px solid rgba(0,0,0,0.1);padding-bottom:20px;box-shadow:0px 1px 10px -1px rgba(0,0,0,0.1);">
			<div class="row ajuste" style="margin-bottom:20px!important;">
				<div>
					<h4>¿Esta seguro de eliminar esta M.T.A?</h4>
				</div>
				<div>
...
<script type="text/javascript">
	...
	$(document).click(function(e){
		...
		if (id==="ventana5" || id==="cerr5" || id==="cerrbtn") {
			$("#ventana5").fadeOut();
		};
