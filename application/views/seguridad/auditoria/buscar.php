					...
					<div id="no-more-tables" >
			            <table class="ajuste table-bordered table-striped table-condensed cf" >
			        		...
			        		<tbody>
			        			...
			        			?>
			        			<tr>
			        				<td data-title="Cedula"><?=$row->persona_cedula?></td>
			        				<td data-title="Usuario"><?=$row->login?></td>
			        				<td data-title="Perfil" class=""><?=$row->perfile_nom_prf?></td>
			        				<td data-title="Estatus" class=""><?=$estatus?></td>
			        				<td data-title="Accion" class="" align="center"><button class="btn btn-success yo" id="mod" onclick="location.href='<?=base_url();?>seguridad/usuarios/modificar/<?=$row->id?>'" style="font-size:11px;box-shadow:-1px 2px 1px -1px #226B12;border:none;">Editar</button></td>
			        			</tr>
			        			<?php
			        				}
			        			?>
...
<script type="text/javascript">
	...
	function cerrar(){
		window.location.href='<?=base_url()?>seguridad/usuarios';
	}
