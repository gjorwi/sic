...
<div class="exito"><i class="fa fa-check-circle" style="font-size:130px;"></i></div><div style="color:#6ECD62;"><h1>Registro Exitoso!...</h1></div>
...
<script type="text/javascript">
	...
	$("#x").attr({'href':'<?=base_url()?>seguridad/inicio'});
