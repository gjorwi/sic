					...
					<div align="left">
						<?php
							if ($consejocomunales->tiporifcc=="P") {
								$tiporifccp="selected";
								$tiporifccj="";
								$tiporifccg="";
								$tiporifccc="";
							}elseif ($consejocomunales->tiporifcc=="J") {
								$tiporifccp="";
								$tiporifccj="selected";
								$tiporifccg="";
								$tiporifccc="";
							}elseif($consejocomunales->tiporifcc=="G"){
								$tiporifccp="";
								$tiporifccj="";
								$tiporifccg="selected";
								$tiporifccc="";
							...
							if ($consejocomunales->est_cco=="t" || $consejocomunales->est_cco=="TRUE") {
								$estatusa="selected";
								$estatusi="";
							}else{
								$estatusa="";
							...
							<div class="row ajuste" style="background-color:#fff;">
								...
								<div class="col-md-6" style="background-color:;padding:0px;">
									...
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									    	<input type="hidden" name="tiporifcc" value="<?=$consejocomunales->tiporifcc?>">
									    	<input type="hidden" name="rifcc" value="<?=$consejocomunales->rifcc?>">
									        <input id="rifcc" readonly maxlength="9" onkeyup="control()" value="<?=$consejocomunales->tiporifcc?>-<?=$consejocomunales->rifcc?>" name="vistarifcc" class="form-control" type="text">
									  </div>
									</div>
									<!-- Text input-->
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									  <input id="nombrecc" readonly value="<?=$consejocomunales->nombrecc?>" name="nombrecc" type="text" placeholder="Ej. Negro Primera" class="form-control input-md">
								...
								<div class="col-md-6" style="background-color:;padding:0px;">
									...
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									  <input id="personacc1" readonly value="<?=$consejocomunales->personacc1?>" name="personacc1" type="text" placeholder="Ej. Pedro Perez" class="form-control input-md">
									  <span class="help-block" style="font-size:11px;color:rgba(0,0,0,0.3);margin:0px;margin-left:2px;padding:0px;padding-top:3px;"><span style="color:rgba(0,0,0,0.5);">Nota:</span> Permitido solo letras.</span>
									  </div>
									</div>
									<!-- Text input-->
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									  <input id="personacc2" readonly maxlength="12" value="<?=$consejocomunales->personacc2?>" name="personacc2" type="text" placeholder="Ej. Ramon Jose" class="form-control input-md">
									  <span class="help-block" style="font-size:11px;color:rgba(0,0,0,0.3);margin:0px;margin-left:2px;padding:0px;padding-top:3px;"><span style="color:rgba(0,0,0,0.5);">Nota:</span> Permitido solo letras.</span>
									  </div>
									</div>
									<!-- Text input-->
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									  <input id="personacc3" readonly maxlength="12" value="<?=$consejocomunales->personacc3?>" name="personacc3" type="text" placeholder="Ej. Javier medina" class="form-control input-md">
									  <span class="help-block" style="font-size:11px;color:rgba(0,0,0,0.3);margin:0px;margin-left:2px;padding:0px;padding-top:3px;"><span style="color:rgba(0,0,0,0.5);">Nota:</span> Permitido solo letras.</span>
									  </div>
									</div>
							...
							<div class="row ajuste" align="center" style="background-color:#fff;margin-top:15px;">
									...
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									    <div class="input-group">
									        <input id="estado" readonly maxlength="30" value="<?=validarEntrada($consejocomunales->estado_nom_est)?>" name="estado" class="form-control" type="text">
									    	...
									    	<input type="hidden" id="estado_id" name="estado_id" value="<?=$consejocomunales->estado_id?>">
									    </div>
									    <span class="help-block" style="color:rgba(0,0,0,0.3);margin:0px;margin-left:2px;padding:0px;padding-top:3px;font-size:11px;"><span style="color:rgba(0,0,0,0.5);">Nota:</span> Debe elegir un Estado.</span>
									  </div>
									</div>
									<!-- Prepended text-->
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									    <div class="input-group">
									        <input id="municipio" readonly maxlength="30" value="<?=validarEntrada($consejocomunales->municipio_nom_mun)?>" name="municipio" class="form-control" type="text">
									    	...
									    	<input type="hidden" id="municipio_id" name="municipio_id" value="<?=$consejocomunales->municipio_id?>">
									    </div>
									    <span class="help-block" style="color:rgba(0,0,0,0.3);margin:0px;margin-left:2px;padding:0px;padding-top:3px;font-size:11px;"><span style="color:rgba(0,0,0,0.5);">Nota:</span> Debe elegir un Municipio.</span>
									  </div>
									</div>
								...
								<div class="col-md-6" align="left" style="background-color:;padding:0px;">
									...
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									    <div class="input-group">
									        <input id="parroquia" readonly maxlength="30" value="<?=validarEntrada($consejocomunales->parroquia_nom_par)?>" name="parroquia" class="form-control" type="text">
									    	...
									    	<input type="hidden" id="parroquia_id" name="parroquia_id" value="<?=$consejocomunales->parroquia_id?>">
									    </div>
									    <span class="help-block" style="color:rgba(0,0,0,0.3);margin:0px;margin-left:2px;padding:0px;padding-top:3px;font-size:11px;"><span style="color:rgba(0,0,0,0.5);">Nota:</span> Debe elegir una Parroquia.</span>
									  </div>
									</div>
									<!-- Prepended text-->
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									    <div class="input-group">
									        <input id="sector" readonly maxlength="30" value="<?=$consejocomunales->sector_nom_sec?>" name="sector" class="form-control" type="text">
									    	...
									    	<input type="hidden" id="sector_id" name="sector_id" value="<?=$consejocomunales->sector_id?>">
									    </div>
									    <span class="help-block" style="color:rgba(0,0,0,0.3);margin:0px;margin-left:2px;padding:0px;padding-top:3px;font-size:11px;"><span style="color:rgba(0,0,0,0.5);">Nota:</span> Debe elegir un Sector.</span>
									  </div>
									</div>
								</div>
							</div>
								...
								<!-- Textarea -->
									<div class="form-group" align="left" style="padding:5px;">
									  ...
									  <div class="col-md-5">                     
									    <textarea class="form-control" readonly id="observacionescc" placeholder="Ej. Calle Polita de Lima casa 5-A" name="observacionescc"><?=$consejocomunales->observacionescc?></textarea>
									  	...
									  	<input type="hidden" value="<?=$consejocomunales->id?>" id="id" name="id">
									  </div>
									</div>
	...
	<div class="contventana" id="contven2" style="margin-top:130px;">
		...
		<div class="row ajuste" style="padding-top:10px!important;background-color:white;border-bottom:1px solid rgba(0,0,0,0.1);padding-bottom:20px;box-shadow:0px 1px 10px -1px rgba(0,0,0,0.1);">
			<div class="row ajuste" style="margin-bottom:20px!important;">
				<div>
					<h4>¿Esta seguro de eliminar este Consejo Comunal?</h4>
				</div>
				<div>
...
<script>
  ...
  var con=0;
	...
	function eliminar(){
		var id=$("#id").val();
		//alert(id);
		window.location.href='<?=base_url();?>consejocomunal/consejoscomunales/eliminar/'+id;
	}
 </script>
