...
<div style="position:absolute;top:-10px;left:120px;color:#9AEE9A;"><i class="fa fa-check-circle" style="font-size:130px;"></i></div><div style="color:#6ECD62;"><h1>Registro Exitoso!...</h1></div>
...
<script>
function explode(){
  window.location.href='<?=base_url()?>configuracion/empresas';
}
