							...
							<div class="row ajuste" style="background-color:#;">
									...
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									    <div class="input-group">
									        <input id="rif" readonly maxlength="9" onkeyup="control()" value="<?= set_value('rif')?>" name="rif" class="form-control" type="text">
								...
								<div class="col-md-6" style="background-color:;padding:0px;">
									...
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									  <input id="razon" readonly value="<?= set_value('razon')?>" name="razon" type="text" placeholder="Ej. " class="form-control input-md">
									  </div>
									</div>
									<!-- Text input-->
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									  <input id="fax" readonly onblur="formatear('fax')" maxlength="12" value="<?= set_value('fax')?>" name="fax" type="text" placeholder="Ej. " class="form-control input-md">
									  <span class="help-block" style="font-size:11px;color:rgba(0,0,0,0.3);margin:0px;margin-left:2px;padding:0px;padding-top:3px;"><span style="color:rgba(0,0,0,0.5);">Nota:</span> Permitido solo numeros.</span>
									  </div>
									</div>
							...
							<div class="row ajuste" align="center" style="background-color:#f4f4f4;margin-top:15px;">
								...
								<div class="col-md-6" align="left" style="background-color:;padding:0px;">
									...
									<div class="form-group" style="padding:5px;">
									  ...
									  <div class="col-md-6">
									  <input id="tipo" readonly name="tipo"  value="<?= set_value('tipo')?>" type="text" placeholder="Ej. pedro@mail.com" class="form-control input-md">
